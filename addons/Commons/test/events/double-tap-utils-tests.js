...
TestCase("[Events Utils - Double Tap] getStartEvent desktop tests", {
    ...
    'test should return mousedown event for desktop browser when PointerEvent is not supported - Chrome': function () {
    ...
    'test should return mousedown event for desktop browser when PointerEvent is not supported - Firefox': function () {
        this.setPointerEventSupport(false);
    ...
    'test should return mousedown event for desktop browser when PointerEvent is not supported - IE': function () {
        this.setPointerEventSupport(false);
    ...
    'test should return mousedown event for desktop browser when PointerEvent is not supported - Safari': function () {
        this.setPointerEventSupport(false);
    ...
    'test should return pointerdown event for desktop browser when PointerEvent is supported - Chrome': function () {
        this.setPointerEventSupport(true);
        this.stubs.getUserAgent.returns("Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.109 Safari/537.36"); // Chrome 48
    ...
    'test should return pointerdown event for desktop browser when PointerEvent is supported - Firefox': function () {
        this.setPointerEventSupport(true);
        this.stubs.getUserAgent.returns("Mozilla/5.0 (Windows NT 6.3; WOW64; rv:44.0) Gecko/20100101 Firefox/44.0"); // Firefox 48
    ...
    'test should return pointerdown event for desktop browser when PointerEvent is supported - IE': function () {
        this.setPointerEventSupport(true);
        this.stubs.getUserAgent.returns("Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; .NET4.0E; .NET4.0C; .NET CLR 3.5.30729; .NET CLR 2.0.50727; .NET CLR 3.0.30729; rv:11.0) like Gecko"); // IE 11
    ...
    'test should return pointerdown event for desktop browser when PointerEvent is supported - Safari': function () {
        this.setPointerEventSupport(true);
        this.stubs.getUserAgent.returns("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A"); // Safari 7.0.3
...
TestCase("[Events Utils - Double Tap] getStartEvent mobile tests", {
    ...
    'test should return touchstart event for mobile browser when PointerEvent is not supported - Chrome on Android': function () {
        this.setPointerEventSupport(false);
    ...
    'test should return touchstart event for mobile browser when PointerEvent is not supported - Native Browser on Android': function () {
        this.setPointerEventSupport(false);
    ...
    'test should return touchstart event for mobile browser when PointerEvent is not supported - Safari on iOS': function () {
        this.setPointerEventSupport(false);
