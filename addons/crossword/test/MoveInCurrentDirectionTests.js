TestCase("[Crossword] Move in current direction tests", {
    ...
    'test given horizontal direction for navigation when moving and no editable or constant cells on right site then do not blur current element': function () {
        this.presenter.setHorizontalDirection();
        ...
        this.validateIsCellInputElementFocused(7, 1);
    },

    'test given horizontal direction for navigation when moving and no editable cells on right site then do not blur current element': function () {
        this.presenter.setHorizontalDirection();
    ...
    'test given vertical direction for navigation when moving and no editable or constant cells on bottom site then do not blur current element': function () {
        this.presenter.setVerticalDirection();
    ...
    'test given vertical direction for navigation when moving and no editable cells on bottom site then do not blur current element': function () {
        this.presenter.setVerticalDirection();
    ...
    'test given TabIndex direction for navigation when moving and then there are no editable cells then do not blur current element': function () {
        this.presenter.setTabIndexDirection();
