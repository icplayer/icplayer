function AddonSwiffyAnimation_create(){
	...
	presenter.createPreview = function (view, model) {
		...
		presenter.$view.append('<div style="color: #444444; font-size: 12px; font-family: Arial;">'+message+'</div>');
    };
	...
	presenter.errorHandler = function(message){
		presenter.$view.append('<div style="color: red; font-size: 12px; font-family: Arial;">'+message+'</div>');
	};
