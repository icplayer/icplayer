TestCase("Model conversion", {
    ...
    'test valid model': function () {
        ...
        assertFalse(convertedModel.isDecimalSeparatorSet);
        assertUndefined(convertedModel.decimalSeparator);
    },
    ...
    'test decimal separator': function () {
        ...
        assertEquals('feedback1.change("BAD");', convertedModel.onIncorrectEvent);
        assertEquals('feedback1.change("PARTIAL");', convertedModel.onPartialEvent);
        assertTrue(convertedModel.isDecimalSeparatorSet);
        assertEquals(",", convertedModel.decimalSeparator);
    },
