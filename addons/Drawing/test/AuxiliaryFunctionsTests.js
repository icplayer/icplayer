TestCase("[Drawing] Auxiliary functions", {
    ...
    'test converting hex to rgba' : function() {
        ...
        assertEquals('rgba(255,255,255,1)', this.presenter.hexToRGBA("#FFFFFF", 100));
        assertEquals('rgba(0,0,0,0.5)', this.presenter.hexToRGBA('#000000', 50));
        assertEquals('rgba(168,5,204,0)', this.presenter.hexToRGBA('#a805cc', 0));
        assertEquals('rgba(16,17,18,1)', this.presenter.hexToRGBA('#101112', 100));

    },

    'test color name to hex' : function () {

        assertEquals(false, this.presenter.colourNameToHex("maka paka"));
