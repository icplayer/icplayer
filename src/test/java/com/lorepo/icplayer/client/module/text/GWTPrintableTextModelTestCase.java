...
public class GWTPrintableTextModelTestCase extends GWTPowerMockitoTest {
	...
	public void initData() throws Exception {
		...
		MAKE_PRINTABLE_DROPDOWNS_NOT_SHOWING_ANSWERS_HTML = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / like</span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / dont like</span> him very much (like).</p> <p>He likes to drive <input id=\"44V2rX-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\">ABC / DEF / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"44V2rX-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
	...
	public void makePrintableDropdownsWithoutUserAnswers() throws Exception {
		...
		expectedTrue = removeIDs(expectedTrue);
		String expectedFalse = removeIDs(MAKE_PRINTABLE_DROPDOWNS_NOT_SHOWING_ANSWERS_HTML);
	...
	public void makePrintableDropdownsWithOnlyRightAnswers() throws Exception {
		...
		String expectedTrue = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <span class=\"ic_text-correct-answer\"><u>like</u></span></span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <span class=\"ic_text-correct-answer\"><u>dont like</u></span></span> him very much (like).</p> <p>He likes to drive <input id=\"hwOM23-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\">ABC / <span class=\"ic_text-correct-answer\"><u>DEF</u></span> / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"hwOM23-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedTrue = removeIDs(expectedTrue);
		String expectedFalse = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <u>like</u></span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <u>dont like</u></span> him very much (like).</p> <p>He likes to drive <input id=\"hwOM23-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\">ABC / <u>DEF</u> / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"hwOM23-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedFalse = removeIDs(expectedFalse);
	...
	public void makePrintableDropdownsWithOnlyWrongAnswers() throws Exception {
		...
		String expectedTrue = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / like</span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / dont like</span> him very much (like).</p> <p>He likes to drive <input id=\"DKa3YI-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\"><span class=\"ic_text-wrong-answer\"><u>ABC</u></span> / DEF / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"DKa3YI-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedTrue = removeIDs(expectedTrue);
		String expectedFalse = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / like</span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / dont like</span> him very much (like).</p> <p>He likes to drive <input id=\"DKa3YI-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\"><u>ABC</u> / DEF / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"DKa3YI-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedFalse = removeIDs(expectedFalse);
	...
	public void makePrintableDropdownsWithRightAndWrongAnswers() throws Exception {
		...
		String expectedTrue = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <span class=\"ic_text-correct-answer\"><u>like</u></span></span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <span class=\"ic_text-correct-answer\"><u>dont like</u></span></span> him very much (like).</p> <p>He likes to drive <input id=\"eXyGEY-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\"><span class=\"ic_text-wrong-answer\"><u>ABC</u></span> / DEF / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"eXyGEY-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedTrue = removeIDs(expectedTrue);
		String expectedFalse = " <p>I <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <u>like</u></span> you very much (like).</p> <p>You <span class=\"printable_dropdown\">aaaaa aa / bbb bb / <u>dont like</u></span> him very much (like).</p> <p>He likes to drive <input id=\"eXyGEY-3\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"5\" class=\"ic_gap\"></input>.</p> <p>She <span class=\"printable_dropdown\"><u>ABC</u> / DEF / GHI</span> him very much (like).</p> <p>It likes to drive <input id=\"eXyGEY-5\" type=\"edit\" data-gap=\"editable\" autocomplete=\"off\" size=\"4\" class=\"ic_gap\"></input>.</p> ";
		expectedFalse = removeIDs(expectedFalse);
