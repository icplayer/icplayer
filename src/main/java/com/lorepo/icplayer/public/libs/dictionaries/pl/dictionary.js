var ice_dictionary_pl = {
	...
	"semi_responsive_set_as_default_failure": "Marking CSS Style as default has failed.",
	"semi_responsive_set_as_default_success": "CSS Style has been marked as default with success.",
	...
	"add_new_style_error_empty_name": "Style name can't be empty string.",
	"add_new_style_error_same_id": "Styles can't have the same ids.",
	"delete_css_style_question": "Are you sure you want to delete style?",
	"delete_style_error_not_enough_styles_to_delete": "There is not enough styles, can't perform delete action.",
	"delete_style_error_style_does_not_exists": "Style does not exists, can't perform delete action.",
	"delete_style_error_style_is_default": "You can't delete default style.",
	"edit_layouts_menu": "Edit Layouts...",
	...
	"add_new_semi_responsive_layout_title": "Add Semi-Responsive Layout",
	"add_new_semi_responsive_layout_error_name_empty": "Semi-responsive layout name can't be empty string.",
	"add_new_semi_responsive_layout_error_treshold": "Semi-responsive treshold have to be a positive number greater than 0.",
	"add_new_semi_responsive_layout_success": "Adding new layout has been performed with success",
	"delete_semi_responsive_layout_warning_default_cant_be_deleted": "Default semi-responsive layout can't be deleted",
	"delete_semi_responsive_layout_question": "Are you sure you want to delete semi-responsive layout? It will delete layout configuration from all pages in content.",
	"delete_semi_responsive_layout_warning_default_cant_be_deleted": "You can't perform delete on default semi responsive layout.",
	"delete_semi_responsive_layout_error_not_enough_layouts": "There is not enough layouts, can't perform delete action.",
	"delete_semi_responsive_layout_error_does_not_exists": "Semi-responsive layout does not exists, can't perform delete action.",
	"delete_semi_responsive_layout_success": "Delete layout has been performed with success",
	"semi_responsive_addon_warning": "Addon inserted may not work properly in semi-responsive layout.<br />For more information see <a href='//www.mauthor.com/doc/en/page/semi-responsive' target='_blank'>documentation.</a>",
	...
	"schemeless_url_warning": "W zasobach dostępnych za pośrednictwem HTTPS i HTTP należy podać bezwględny adres URL.<br />Więcej informacji możesz uzyskać w <a href='//www.mauthor.com/doc/en/page/Online-resources' target='_blank'>dokumentacji.</a>",
