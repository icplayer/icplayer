var ice_dictionary_bl = {
	...
	"Media_Recorder_speech_text_default_record_play_button": "Default record play button",
	"Media_Recorder_speech_text_default_record_stop_button": "Default record stop button",
