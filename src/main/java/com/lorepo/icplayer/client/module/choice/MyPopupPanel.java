...
//public class MyPopupPanel extends SimplePanel implements SourcesPopupEvents,
//    EventPreview, HasAnimation, HasCloseHandlers<MyPopupPanel> {
//
//  /**
//   * A callback that is used to set the position of a {@link MyPopupPanel} right
//   * before it is shown.
//   */
...
//     * @see MyPopupPanel#setPopupPositionAndShow(PositionCallback)
//     */
...
//    /**
//     * The {@link MyPopupPanel} being affected.
//     */
//    private MyPopupPanel curPanel = null;
//
//    /**
//     * Indicates whether or not the {@link MyPopupPanel} is in the process of
...
//
//    /**
//     * The offset height and width of the current {@link MyPopupPanel}.
//     */
...
//     */
//    public ResizeAnimation(MyPopupPanel panel) {
//      this.curPanel = panel;
//    }
//
//    /**
...
//
//  /**
//   * The {@link ResizeAnimation} used to open and close the {@link MyPopupPanel}s.
//   */
...
//  }
//
//  public HandlerRegistration addCloseHandler(CloseHandler<MyPopupPanel> handler) {
...
//   * to actually attached/detach the {@link MyPopupPanel} to the page.
//   *
...
//
//  /**
//   * Get the glass element used by this {@link MyPopupPanel}. The element is not
...
//
//  /**
//   * Enable or disable animation of the {@link MyPopupPanel}.
//   *
...
//
//  /**
//   * Register or unregister the handlers used by {@link MyPopupPanel}.
//   */
