...
import com.lorepo.icf.properties.IStaticStringProperty;
import com.lorepo.icf.utils.StringUtils;
import com.lorepo.icf.utils.XMLUtils;
import com.lorepo.icplayer.client.module.addon.AddonModel;

public class StaticStringAddonParam implements IAddonParam{
	...
	public StaticStringAddonParam(AddonModel parent, String type) {
		this.parent = parent;
		this.type = type;
	}
	...
	public IProperty getAsProperty() {
		...
		IProperty property = new IStaticStringProperty() {
	...
	public IAddonParam makeCopy() {
		...
		IAddonParam param = new StaticStringAddonParam(getAddonModel(), type);
		param.setName(name);
