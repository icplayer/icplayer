...
public class PlayerApp {
	...
	private boolean shouldUseStateInPrintable = true;
	...
	public void generatePrintableHTML(PrintableParams params) {
		...
		if (this.shouldUseStateInPrintable) {
	...
	public void setPrintableStateUsage(boolean shouldUseState) {
        this.shouldUseStateInPrintable = shouldUseState;
    };
