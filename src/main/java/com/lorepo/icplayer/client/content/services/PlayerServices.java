...
import com.lorepo.icplayer.client.module.api.event.ResizeWindowEvent;
...
public class PlayerServices implements IPlayerServices {
    ...
    private native void jQueryUiDroppableIntersectFix()  /*-{
        ...
        $wnd.$.ui.intersect = $wnd.$.ui.intersect = function (draggable, droppable, toleranceMode) {
            ...
            var x1 = (draggable.positionAbs || draggable.position.absolute).left,
                x2 = x1 + draggable.element[0].getBoundingClientRect().width,
                y1 = (draggable.positionAbs || draggable.position.absolute).top,
                y2 = y1 + draggable.element[0].getBoundingClientRect().height;
    ...
    private static native void handleResizeEvent(PlayerServices playerServices) /*-{
        window.onresize = function () {
            playerServices.@com.lorepo.icplayer.client.content.services.PlayerServices::sendResizeEvent()();
        };
    }-*/;
