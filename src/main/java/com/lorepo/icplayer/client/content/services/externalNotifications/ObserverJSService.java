...
public class ObserverJSService extends JavaScriptObject {
    ...
    public static native ObserverJSService create(IObserverService s) /*-{
        ...
        obj.addObserver = function(type, obj) {
           // return s.@com.lorepo.icplayer.client.content.services.externalNotifications.ObserverService::addObserverJS(Ljava/lang/String;Lcom/lorepo/icplayer/client/content/services/externalNotifications/Observer)(type, obj);
        };
