 ...
 * <ul class='css'>
 * <li>.ic_progress { primary style } </li>
 * <li>.ic_progress .ic_progress-bar { the actual progress bar }
 * </li>
 * <li>.ic_progress .ic_progress-text { text on the bar } </li>
 * <li>.ic_progress .ic_progress-text-firstHalf { applied to text
 * when progress is less than 50 percent } </li>
 * <li>.ic_progress .ic_progress-text-secondHalf { applied to
 * text when progress is greater than 50 percent } </li>
 * </ul>
 */
public class ProgressBar extends Widget /*implements ResizableWidget*/ {

  private static final String DEFAULT_TEXT_CLASS_NAME = "ic_progress-text";
